...
class SermonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sermon" do
    assert_difference('Sermon.count') do
      post sermons_url, params: { sermon: { date: @sermon.date, place: @sermon.place, preacher: @sermon.preacher, title: @sermon.title } }
    end
  ...
  test "should update sermon" do
    patch sermon_url(@sermon), params: { sermon: { date: @sermon.date, place: @sermon.place, preacher: @sermon.preacher, title: @sermon.title } }
